...
/**
 * Task for uploading the selected image to Vision API.
 */
...
public class CloudVisionTask extends AsyncTask<Object, Void, String> {
    ...
    public CloudVisionTask(Bitmap bitmap, PackageManager packageManager, CloudVisionCallback callback) {
        this.bitmap = bitmap;
            ...
            VisionRequestInitializer requestInitializer =
                    new VisionRequestInitializer(CLOUD_VISION_API_KEY) {
                        ...
                        protected void initializeVisionRequest(VisionRequest<?> visionRequest)
                            ...
                            visionRequest.getRequestHeaders().set(ANDROID_PACKAGE_HEADER, MainActivity.PACKAGE_NAME);

                            String sig = PackageManagerUtils.getSignature(packageManager, MainActivity.PACKAGE_NAME);
    ...
    private String convertResponseToString(BatchAnnotateImagesResponse response) {
        StringBuilder message = new StringBuilder("Vision API found:\n");
